        ...
        <tbody>
            <?php foreach ($users as $user) { ?>
                <tr>
                    ...
                    <td><?= $user["email"]; ?></td>
                    <td>
                        <a href="user.php?id=<?= $user['id'] ?>" class="btn btn-primary">Modifier</a>
                        <a href="user_delete.php?id=<?= $user['id'] ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce compte ?')" class="btn btn-primary">Supprimer</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
