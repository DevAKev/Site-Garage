...
<body>
    ...
    <div class="container-fluid">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: auto;">
            <a href="/index.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                <img src="/assets/images/Logo Garage V.PARROT-3.png" alt="logo" width="70" height="70" class="rounded-circle me-4">
                <span class="fs-4 p-2">Garage V. Parrot</span>
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto align-items-center">
                <li class="nav-item">
                    <a href="/admin/index.php" class="nav-link active" aria-current="page" style="font-size: 2rem;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-house me-4" viewBox="0 0 16 16">
                ...
                <br>
                <li>
                    <a href="/admin/templates/services.php" class="nav-link text-white" style="font-size: 1rem;">
                ...
                <li>
                    <a href="/ajouter_modifier_annonces.php" class="nav-link text-white" style="font-size: 1rem;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-car-front me-4" viewBox="0 0 16 16">
                ...
                <li>
                    <a href="/admin/templates/reviews.php" class="nav-link text-white" style="font-size: 1rem;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-chat-dots me-4" viewBox="0 0 16 16">
                ...
                <li>
                    <a href="/admin/templates/messages.php" class="nav-link text-white" style="font-size: 1rem;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-envelope-at me-4" viewBox="0 0 16 16">
                ...
                ?>
                    ...
                    <li>
                        <a href="/admin/templates/users.php" class="nav-link text-white" style="font-size: 1rem;">
