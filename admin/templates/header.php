...
<body>
    ...
    <div class="container-fluid">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: auto;">
            ...
            <hr>
            <ul id="functions-list" class="nav nav-pills mb-auto align-items-center">
                <li class="nav-item">
                ...
                <li>
                    <a href="/add_car.php" class="nav-link text-white" style="font-size: 1rem;"> <!-- UPDATE NEW LINK add_car.php PAGE -->
                ...
                <li>
                    <a href="/admin/templates/messages.php" class="nav-link text-white" style="font-size: 1rem;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-envelope-at me-2" viewBox="0 0 16 16">
                ...
                ?>
                    ...
                    <li>
                        <a href="/admin/templates/users.php" class="nav-link text-white" style="font-size: 1rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-fill-gear me-2" viewBox="0 0 16 16">
